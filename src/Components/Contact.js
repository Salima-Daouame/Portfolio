...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_rizhgk8', 'template_trpdd5c',
      form.current, '1MawNZI8Yy5XKAzV9')
      .then((result) => {
    ...
    <>
      ...
      >
        ...
        <div className="socialMedia">
          <SocialMediaIcon icon={<LinkedInIcon />} name="LinkedIn" link="https://www.linkedin.com/in/salima-daouame-87494b208/" />
          <SocialMediaIcon icon={<GitHubIcon />} name="GitHub" link="https://github.com/Salima-Daouame" />
        </div>
