...
function About() {
  return (
    <>
      <div name="about" class="w-full_div" id='about'>
        <div class="flex_div">
          <div class="section_about">
            <div class="class_section">
              <div class="text_about"><span>About</span> </div>
            </div>
            <div class="text_righ">
              <p>Hi. I'm Salima, great to meet you. I would be grateful if you could take a look around.</p>
            </div>
          </div>
          ...
          <div class="about_div">
            ...
            <div class="text_left">
              <p>Building exceptional software that improves the lives of those around me is my passion.
                ...
                I have knowledge in HTML, CSS, ReactJs, JavaScript, C, C#, Asp.Net, and Java.
